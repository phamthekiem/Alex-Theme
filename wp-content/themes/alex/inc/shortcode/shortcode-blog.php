...
class sh_blog_shortcode {
	 ...
	 *
	 */
	function sh_general_post_html ( $post_class = array(), $atts = array(), $image_size = 'large' ) {
		extract( shortcode_atts( array(
			'posts_per_page'				=> '5',
			'categories'					=> '',
			'viewmore_text'					=> __( 'Read more', 'shtheme' ),
		...
		$html .= '<div class="entry-content">';
			...
			if ( $hide_meta == '1' ) {
				$html .= '<div class="entry-meta">';
					$html .= '<span class="date-time"><i class="fas fa-calendar-alt"></i>'. get_the_time('d/m/Y') .'</span>';
	 ...
	 *
	 */
	function sh_general_post_html_style_2 ( $post_class = array(), $atts = array(), $image_size = 'large' ) {
		extract( shortcode_atts( array(
			'posts_per_page'				=> '5',
			'categories'					=> '',
			'viewmore_text'					=> __( 'Read more', 'shtheme' ),
