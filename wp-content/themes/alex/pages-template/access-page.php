...
<section class="about">
  <div class="about-avatar">
    <div class="access-bg" style="background-image:url('../image/レイヤー 858.png');"></div>
    <div class="overlay-about">
      <div class="about-left-text">
      </div>
      <div class="about-right-text">
        <span class="company-info">会社案内</span>
        <h1 class="about-heading">ACCESS</h1>
      </div>
    </div>
  </div>
</section>
<nav class="submenu-tabs">
  <div class="container">
    <ul>
      <li><a href="#東京本社">東京本社</a></li>
      <li><a href="#島根支社">島根支社</a></li>
      <li><a href="#ベトナムスタジオ">ベトナムスタジオ</a></li>
    </ul>
  </div>
</nav>
<section class="access-map">
    ...
    <div class="footer-classic-gmap">
      <div class="google-map-container" style="height: 500px; overflow: hidden;">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d202.39831811366471!2d139.7428421!3d35.7416336!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188d06950226b7%3A0x3823e3ecc936f2d9!2z44ix44Ki44Os44OD44Kv44K5!5e0!3m2!1sja!2s!4v1754910212901!5m2!1sja!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>
    </div>
    </div>
...
<section class="recruit-heading" id="東京本社">
...
<section class="recruit-heading" id="島根支社">
  <div class="recruit-header">
    <img class="recruit-bg" src="../image/グループ 19.png" alt="帯背景">
  </div>
...
<section class="recruit-heading" id="ベトナムスタジオ">
  <div class="recruit-header">
    <img class="recruit-bg" src="../image/グループ 19.png" alt="帯背景">
  </div>
